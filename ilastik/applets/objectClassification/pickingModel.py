...
class PickingModel(QObject):
    ...
    def endDrawing(self, pos):
        #FIXME:
        #for now, we only highlight the start pixel, no matter where the mouse has moved meanwhile
        
        self.bb = QRect(QPoint(pos.x(),pos.y()), QSize(1,1))
        '''
