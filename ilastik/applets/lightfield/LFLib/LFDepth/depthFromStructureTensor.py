...
class DepthFromStructureTensor(Operator):
    ...
    sigmaXStrength = InputSlot() #defines a scaling factor for the sigma in x direction
    ...
    colorMode = InputSlot() # defines the color conversion mode, 0: rgb->gray, 1: rgb->hsv->v
    useThreading = InputSlot()
